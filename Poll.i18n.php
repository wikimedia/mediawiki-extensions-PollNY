...
$messages['fa'] = array(
	...
	'createpoll' => 'ساخت یک نظرسنجی',
	'randompoll' => 'نظرسنجی تصادفی',
	'viewpoll' => 'مشاهده نظرسنجی ها',
	'poll-desc' => 'سیستم نظرسنجی پیشرفته که از صفحه های ویژه استفاده می کند و اجازه وارد کردن نظرسنجی ها را به صفحه های ویکی می دهد',
	...
	'poll-admin-status-nav' => 'فیلتر بر اساس وضعیت',
	'poll-admin-title-all' => 'مدیریت نظرسنجی - نمایش همه نظرسنجی ها',
	'poll-admin-title-closed' => 'مدیریت نظرسنجی - مشاهده نظرسنجی های بسته شده',
	'poll-admin-title-flagged' => 'مدیریت نظرسنجی - مشاهده نظرسنجی های علامت گذاری شده',
	'poll-admin-title-open' => 'مدیریت نظرسنجی - مشاهده نظرسنجی های باز',
	'poll-admin-viewall' => 'مشاهده همه',
	'poll-ago' => '$1 پیش',
	...
	'poll-create-threshold-reason' => 'متاسفم, تا زمانی که تعداد ویرایش های شما به $1 نرسد نمی توانید نظرسنجی ایجاد کنید.',
	...
	'poll-edit-button' => 'ذخیره صفحه',
	'poll-edit-desc' => 'نظرسنجی جدید',
	'poll-edit-image' => 'ویرایش تصویر',
	'poll-edit-invalid-access' => 'دسترسی غیر معتبر',
	'poll-edit-title' => 'ویرایش نظرسنجی - $1',
	'poll-embed' => 'جاسازی در صفحه ویکی',
	'poll-enterquestion' => 'شما باید یک سوال وارد کنید.',
	'poll-finished' => '<b>هیچ نظرسنجی دیگری وجود ندارد.  <a href="$1">نظرسنجی خود را اضافه کنید!</a></b>  <a href="$2">مشاهده نتایج این نظرسنجی</a>.',
	'poll-flagged' => 'این نظرسنجی علامت گذاری شده است',
	'poll-flagged-message' => 'آیا مطمئن هستید می خواهید این نظرسنجی را علامت گذاری کنید؟',
	'poll-flag-poll' => 'علامت گذاری نظرسنجی',
	'poll-hash' => '# کاراکتری غیرمعتبر برای سوال نظر سنجی است.',
	'poll-image-label' => 'افزودن یک تصویر',
	'poll-instructions' => 'سوال خود را بپرسید, چند گزینه برای جواب انتخاب کنید, بر روی دکمه "{{int:poll-create-button}}" کلیک کنید. به همین راحتی!',
	'poll-js-action-complete' => 'عمل مورد نظر انجام شد.',
	'poll-js-loading' => 'در حال بارگذاری...',
	'poll-next' => 'بعدی',
	'poll-next-poll' => 'نظرسنجی بعدی',
	'poll-no-more-message' => 'شما به همه نظرسنجی ها رأی دادید!<br /> ناراحت نشو, [[Special:CreatePoll|نظرسنجی خودت رو ایجاد کن]]!',
	...
	'poll-take-button' => '< بازگشت به نظرسنجی',
	...
	'poll-view-answered-times' => '{{PLURAL:$1|یک بار|$1 بار}} جوب داده شده است',
	'poll-view-all-by' => 'مشاهده همه نظرسنجی های $1',
	'poll-voted-for' => 'شما به $1 {{PLURAL:$1|نظرسنجی|نظرسنجی}} از <b>$2</b> رأی داده اید و <span class="profile-on">$3 points</span> دریافت کردید.',
	'poll-votes' => '{{PLURAL:$1|یک رأی|$1 رأی}}',
	'poll-woops' => 'اوه!',
	'poll-would-have-earned' => 'درصورتی که [[Special:UserLogin/signup|عضو ]] بودید مقدار <span class="profile-on">$1 امتیاز</span> دریافت می کردید!',
	'poll-time-ago' => '$1 پیش',
